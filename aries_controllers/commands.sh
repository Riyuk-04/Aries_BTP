...
--genesis-file /home/ishan/pool1.txn --seed 000000000000000000000000Steward1 --wallet-type indy --wallet-name e5 --wallet-key e5 \
...
--genesis-file /home/ishan/pool1.txn --wallet-type indy --wallet-name e6 --wallet-key e6 \
--log-level debug --replace-public-did --auto-provision --auto-store-credential --auto-accept-requests --auto-respond-presentation-proposal --auto-verify-presentation
