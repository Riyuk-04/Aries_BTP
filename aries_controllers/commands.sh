...
--genesis-file /home/ishan/pool1.txn --seed 000000000000000000000000Steward1 --wallet-type indy --wallet-name u4 --wallet-key u4 \
...
--genesis-file /home/ishan/pool1.txn --wallet-type indy --wallet-name u5 --wallet-key u5 \
--log-level debug --replace-public-did --auto-provision --auto-store-credential --auto-accept-requests --auto-respond-presentation-proposal --auto-verify-presentation

aca-py start -it http 0.0.0.0 10000 -ot http -e http://127.0.0.1:10000 --admin-insecure-mode --admin 0.0.0.0 10001 \
--genesis-file /home/ishan/pool1.txn --seed 000000000000000000000000Steward2 --wallet-type indy --wallet-name u6 --wallet-key u6 \
--log-level debug --replace-public-did --auto-provision --auto-store-credential --auto-accept-requests --auto-respond-presentation-proposal --auto-verify-presentation
