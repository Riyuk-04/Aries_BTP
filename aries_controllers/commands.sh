...
--genesis-file /home/ishan/pool1.txn --seed 000000000000000000000000Steward1 --wallet-type indy --wallet-name y4 --wallet-key y4 \
...
--genesis-file /home/ishan/pool1.txn --wallet-type indy --wallet-name y5 --wallet-key y5 \
--log-level debug --replace-public-did --auto-provision --auto-store-credential --auto-accept-requests --auto-respond-presentation-proposal --auto-verify-presentation

aca-py start -it http 0.0.0.0 10000 -ot http -e http://127.0.0.1:10000 --admin-insecure-mode --admin 0.0.0.0 10001 \
--genesis-file /home/ishan/pool1.txn --seed 000000000000000000000000Steward2 --wallet-type indy --wallet-name y6 --wallet-key y6 \
--log-level debug --replace-public-did --auto-provision --auto-store-credential --auto-accept-requests --auto-respond-presentation-proposal --auto-verify-presentation
